...
- **성도 등록** — 이름, 직분, **관심** 표시, 그룹(펼침 메뉴에서 선택), 연락처, 기도 제목 메모
- **심방이 오래된 분이 위로** — 각 그룹 안에서 마지막 심방이 오래된 순으로 정렬
- **구간별 보기** — 검색창 옆 **심방 간격** 메뉴로 그 구간의 분만 모아 봅니다.
- **그룹 관리** — 성도 창의 그룹 메뉴에서 그룹을 추가·삭제하고 ▲▼ 로 순서 조정 (삭제하면 그 그룹 성도는 미배정으로 이동)
- **검색 · 그룹 필터**
...
4. 그룹은 성도 추가 창의 그룹 메뉴 맨 아래 **⚙ 그룹 추가 · 삭제…** 에서 만들고 지웁니다.
