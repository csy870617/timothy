...
- **성도 등록** — 이름, 직분, 구역(펼침 메뉴에서 선택), 연락처, 기도 제목 메모
- **심방이 오래된 분이 위로** — 각 구역 안에서 마지막 심방이 오래된 순으로 정렬
- **구간별 보기** — 검색창 옆 **심방 간격** 메뉴로 그 구간의 분만 모아 봅니다.
...
**심방 간격** 메뉴는 각 구간에 몇 분이 있는지 숫자를 함께 보여 줍니다.
...
4. 구역은 **구역 관리** 에서 추가하고 삭제합니다. 성도 추가 창의 구역 메뉴 맨 아래에서도 열 수 있습니다.
